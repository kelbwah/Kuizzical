...
export default function Navbar(props){
    return (
        <React.Fragment>
            <div className="fixed flex flex-col w-screen items-center justify-center">
                <nav className="flex w-full justify-between lg:px-12 md:px-12 px-8 lg:pt-2 md:pt-2 pt-4 pb-2 bg-slate-50 items-center"> 
                    ...
                    <div className="flex lg:gap-8 md:gap-8 gap-4">
                        ...
                        <button onClick="" className="lg:text-sm md:text-sm text-xs bg-yellow-400 rounded-xl px-4 py-3 hover:bg-yellow-500 active:bg-yellow-600 ease-in-out duration-200 font-medium">Sign up</button>
                    </div>
                </nav>
