...
const iconStyles = (iconType) => {
    return `${iconType === 'user' ? 'h-5 w-6' : iconType === 'quiz' ? 'h-6 w-6' : 'h-6 w-6'} text-gray-500 hover:text-gray-50 active:text-gray-400 ease-in-out duration-300`;
};
...
export const LeftNavbarActions = () => {
    return <NavbarButton url={'/quizzes'} title={'Quizzes'} icon={quizIcon} />;
};
