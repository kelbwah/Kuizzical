                    ...
                    <div className='w-full h-full flex flex-col fade-in-fast'>
                        <div className='flex w-full justify-between items-center mb-12'>
                            <div className='flex flex-col gap-2'>
                                <p className='lg:text-4xl md:text-4xl text-3xl font-black hover:text-yellow-300 active:text-yellow-400 ease-in-out duration-300 select-none'>
                                    {quiz.title}
                                </p>
                                <p className='font-medium lg:text-sm md:text-sm text-xs hover:text-yellow-300 active:text-yellow-400 hover:underline cursor-pointer ease-in-out duration-200'>
                                    By {quiz.author['username']}
                                </p>
                            </div>
                            <Tooltip
                                content={`${linkCopied === false ? 'Share' : 'Copied to Clipboard!'}`}
                                className='translate-x-0.5'
                            >
                                <MdOutlineIosShare
                                    onClick={shareQuiz}
                                    className='translate-x-0.5 lg:text-3xl md:text-3xl text-2xl text-gray-500 hover:text-gray-200 active:text-gray-400 ease-in-out duration-200 cursor-pointer'
                                />
                            </Tooltip>
                        </div>
                        <MainCardComponent
